...
def visualization_framework(model,
                            ...
                            **kwargs):
    """
    Returns feature importance and other visualization techniques. Methods: "GFI" and "GFI_only" work for elastic net, random forest,.. (TODO: add models) if an aggregation by yeo7 is possible. 
    "FI" and "FI_only" work for elastic net, random forest, .. (TODO: add models).
